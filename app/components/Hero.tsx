                ...
                <div className="mb-8 flex flex-wrap justify-between md:mb-16">
                    ...
                    <div className="mb-12 flex w-full md:mb-16 lg:w-2/3">
                        ...
                        <div className='overflow-hidden rounded-lg bg-gray-100 shadow-lg'>
                            <Image src={urlFor(data.image2).url()} alt="Great Photo" 
                            className='h-full w-full object-cover object-center'
                            width={500}
                            height={500}
                            />
                    ...
                    <div className='flex flex-col item-center justify-between gap-8 md:flex-row'>
                        <div className='flex h-12 w-64 divide-x overflow-hidden rounded-lg border'>
                            ...
                            <Link href="/Brød" className='flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray200'>
                                Brød
                            </Link>
